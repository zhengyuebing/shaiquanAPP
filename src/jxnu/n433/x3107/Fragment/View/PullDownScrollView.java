...
public class PullDownScrollView extends LinearLayout{
	...
	private PullDownScrollView pullDownScrollView = (PullDownScrollView) findViewById(R.id.refresh_root);
	...
	private void handleHeadElastic(MotionEvent event) {
		if (refreshListener != null && mElastic != null) {
			...
			case MotionEvent.ACTION_CANCEL:
				...
				pullDownScrollView.requestDisallowInterceptTouchEvent(false);
			...
			case MotionEvent.ACTION_MOVE:
				...
				pullDownScrollView.requestDisallowInterceptTouchEvent(true);
